...
/*Update name of File*/
DOMCacheGetOrSet('saveStringInput').addEventListener('blur', (e: any) => updateSaveString(<HTMLInputElement>e.target));
...
// SINGULARITY TAB
    ...
    // Import button
    DOMCacheGetOrSet('importfile').addEventListener('change', async (e: any) => {
